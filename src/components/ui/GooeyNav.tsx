    ...
    <>
      ...
      <div className="gooey-nav relative" ref={containerRef}>
        ...
        >
          <ul
            ref={navRef}
            className="flex gap-6 lg:gap-8 list-none p-0 px-4 m-0 relative z-[3]"
            style={{
              color: "white",
          ...
          >
            {items.map((item, index) => (
              <li
                key={index}
                className={`py-[0.6em] px-[1em] rounded-full relative cursor-pointer transition-[background-color_color_box-shadow] duration-300 ease shadow-[0_0_0.5px_1.5px_transparent] text-white font-medium ${
